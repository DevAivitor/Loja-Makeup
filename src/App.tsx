      ...
      <AnimatePresence>
        {toastMessage && (
          <motion.div
            ...
            className="toast-notification fixed bottom-8 left-1/2 -translate-x-1/2 z-500 bg-brand-rose text-brand-nude-dark px-6 py-4 rounded-2xl shadow-[0_20px_50px_rgba(19,9,4,0.4)] border border-brand-gold/40 text-xs font-semibold tracking-wide text-center"
          >
            {toastMessage}
          </motion.div>
        )}
